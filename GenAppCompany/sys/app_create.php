...
<div id="main-content">
	<div class="col-xs-12-">
		...
		<div class="panel-heading">
			<div class="row">
				<div class="col-xs-6">
					<h3 class="panel-title"><strong>รายละเอียดแอปพลิเคชัน</strong></h3>
				</div>
				<div class="col-xs-6 ">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row form-group">
					...
					<form id="form_createapp" action="set_data.php" method ="post">
						<div class ="col-sm-2">
					...
					<div class="row form-group">
						...
						<div class="col-sm-7">
							...
							<input id="icon_app"  type="file" name="iconfile" onchange="showIconApp(this);"  accept="image/*" required/>
							<span class="text-muted">เฉพาะไฟล์ .jpg, .png</span><br />
							<img id="showicon" src="<?php echo $app_icon; ?>" alt="icon_app" width="150" height="150" hidden />
						</div>
						<div class ="col-sm-2">
					...
					<div class="row form-group">
				  	 ...
				  	 <input id="splash_app" value="<?php echo $app_splash; ?>" type="file" name="splashfile" onchange="showSplashApp(this);"  accept="image/*" required/>
						 <span class="text-muted">เฉพาะไฟล์ .jpg, .png</span><br />
						<img id="showsplash" src="<?php echo $app_splash; ?>" alt="splash_app" width="150" height="150"  hidden/>
						</div>
						<div class ="col-sm-2">
					...
					<div class="row">
						...
						<div class="col-xs-4 text-right">
							<button type="submit" id="save_form_appcreate" class="btn btn-primary">บันทึก</button>
	...
	<!--Main Location-->
  <div class="listmainlocation panel-heading" hidden>
    <div class="row">
      <div class="col-xs-6">
  ...
  <div id="listmainlocation" class="listmainlocation col-xs-12-" hidden>
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="row">
          <div class="col-xs-6">
...
<?php
 ...
 ?>
	<!-- location -->
  <div class="panel-heading listlocation" hidden>
    <div class="row">
      <div class="col-xs-6">
	...
	<div id="listlocation" class="listlocation col-xs-12-" hidden > <!--hidden -->
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
					<div class="col-xs-6">
