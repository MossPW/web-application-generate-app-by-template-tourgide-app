   ...
   <form id="form_addlocation" action="set_data.php" method ="post">
    ...
    <div class="panel-body">
      <div class="row form-group">
        ...
        <div class ="col-sm-2">
          <label class="control-label"><span class="asterisk">*</span>ชื่อสถานที่ย่อย</label>
  ...
  <!--end select main location -->
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-7">
         ...
         <input id="location_pic" class="input-img-file"type="file"  accept="image/*" name="locationapppic" onchange="showLocationPic(this);" required />
